...
int main() 
{
    ...
    const char *shadernames[2] = {SHADERS_PATH "/04_SimpleShader/04ss.vert", SHADERS_PATH "/04_SimpleShader/04ss.frag"};
    ...
    while(!glfwWindowShouldClose(window)) {
        ...
        glUniform2f(mousePositionHandle, xpos, ypos); //direkt gecaster
