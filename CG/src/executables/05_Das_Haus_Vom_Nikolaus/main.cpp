...
int main() 
{
    ...
    const char *shadernames[2] = {SHADERS_PATH "/05_Haus_von_Nikolaus/05_hvn.vert", SHADERS_PATH "/05_Haus_von_Nikolaus/05_hvn.frag"};
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        modelMatrix = glm::rotate(modelMatrix, 20.0f, glm::vec3(1, 0, 0));
        modelMatrix = glm::rotate(modelMatrix, alfa, glm::vec3(0, 1, 0));
